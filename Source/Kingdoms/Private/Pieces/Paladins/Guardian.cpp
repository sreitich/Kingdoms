...
void AGuardian::OnActiveClicked()
{
	...
	if (!ActiveAbilityConfirmationWidget)
	{
		...
		ActiveAbilityConfirmationWidget = CreateWidget<UGuardian_ActiveConfirmation>(GetWorld(), ActiveAbilityConfirmationClass, FName("Guardian Active Ability Confirmation Widget"));
