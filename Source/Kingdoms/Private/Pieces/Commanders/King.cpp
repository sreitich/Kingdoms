...
void AKing::OnActiveClicked()
{
	...
	if (!ActiveAbilityConfirmationWidget)
	{
		...
		ActiveAbilityConfirmationWidget = CreateWidget<UKing_ActiveAbilityConfirmation>(Cast<APlayerController>(GetInstigator()->GetController()), ActiveAbilityConfirmationClass, FName("King Active Ability Confirmation Widget"));
