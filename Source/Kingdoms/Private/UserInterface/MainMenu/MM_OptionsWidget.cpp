...
void UMM_OptionsWidget::DeactivateWidget()
{
...
void UMM_OptionsWidget::NativeConstruct()
{
	Super::NativeConstruct();

	/* Bind the "back" button to deactivate this widget. */
	BackButton->OnClicked.AddDynamic(this, &UMM_OptionsWidget::OnBackClicked);
	...
	AnimBinding.BindDynamic(this, &UMM_OptionsWidget::OnDeactivatedAnimEnd);
	BindToAnimationFinished(OnDeactivatedAnim, AnimBinding);
}

void UMM_OptionsWidget::OnDeactivatedAnimEnd()
{
	...
	HUDPtr->ChangeMenus();
	HUDPtr->CreateOptionsWidget(true);
}

void UMM_OptionsWidget::OnBackClicked()
{
