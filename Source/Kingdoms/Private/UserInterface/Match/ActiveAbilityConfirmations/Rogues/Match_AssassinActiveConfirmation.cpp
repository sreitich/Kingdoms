...
void UMatch_AssassinActiveConfirmation::DestroyWidget(bool bReset)
{
...
void UMatch_AssassinActiveConfirmation::OnAttackClicked()
{
...
void UMatch_AssassinActiveConfirmation::OnCancelClicked()
{
	/* Destroy this widget and reset the player and all tiles. */
	DestroyWidget(true);
}
